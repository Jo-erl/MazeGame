...
var maze = function (X, Y) {
    ...
    this.draw_canvas = function (id) {
            ...
            for (var i = 0; i < 2 * this.N + 1; i++) {
                for (var j = 0; j < 2 * this.M + 1; j++) {
                    if (this.Board[i][j] != ' '){//} && this.Board[i][j] != '&') {
                        this.ctx.fillStyle = "#ca0039";//Grid color
        ...
        //    console.log(temp)
            this.Board[x[0]][x[1]] = '&'
            this.ctx.fillStyle = "#ffbf00"; //user
    ...
    this.moveclear = function (a,b) {
        var scale = this.S;
        this.ctx = this.canvas.getContext('2d');
        this.ctx.fillStyle = "#cdcdcd";// user path
...
//function drawMoves() {
   // document.getElementById("c").innerHTML = "Your Moves: "+ m.getMoves()
//}
// drawMoves();
